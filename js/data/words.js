  ...
  themes: [
    ...
    },
    {
      ...
      levels: [
        ...
        { words: ['FRUTAPAO','JENIPAPO','CAMBUCI','BACURI','UMBU'], size: 15, time: 180, maxErrors: 3 },
      ]
    },
    {
      id: 'esportes',
      ...
      levels: [
        ...
        { words: ['FUTSAL','BEISEBOL','CRIQUETE','POLOAQUATICO','TIROCOMARCO'], size: 14, time: 165, maxErrors: 3 },
